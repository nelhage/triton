...
@triton.heuristics({'num_warps': lambda args_by_name, **meta: num_warps(args_by_name['N'])})
@triton.heuristics({'BLOCK': lambda args_by_name, **meta: next_power_of_2(args_by_name['N'])})
@triton.jit
